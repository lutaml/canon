...
==== Advanced: Element-level whitespace sensitivity

When using `structural_whitespace: :strict`, you can control whitespace sensitivity at the element level using:
...
The `xml:space` attribute is the XML standard way to declare whitespace sensitivity:
