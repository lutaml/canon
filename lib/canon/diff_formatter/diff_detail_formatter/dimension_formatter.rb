...
expand_difference: false)
        ...
        #
        # The Reason line built by XmlComparator already names the adjacency
        # position (preceding / following / surrounding) and which side has
        # the whitespace.  This renderer surfaces the two sides separately
        # for the side-by-side display and lets the Reason carry the label.
        #
        # @param diff [DiffNode, Hash] Difference node
        # @param use_color [Boolean] Whether to use colors
        # @return [Array] Tuple of [detail1, detail2, changes]
