    ...
    class SerializationMatcher
      ...
      def diff_output
        ...
        formatter = Canon::DiffFormatter.new(
          ...
          pretty_printer_indent: diff_config.pretty_printer.indent,
          pretty_printer_indent_type: diff_config.pretty_printer.indent_type,
          strict_whitespace_elements: diff_config.strict_whitespace_elements,
          normalize_whitespace_elements: diff_config.normalize_whitespace_elements,
          insensitive_whitespace_elements: diff_config.insensitive_whitespace_elements,
